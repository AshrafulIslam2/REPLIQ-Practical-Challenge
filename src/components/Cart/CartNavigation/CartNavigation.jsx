...
const CartNavigation = () => {
  return (
    <div className="flex  justify-evenly gap-8 overflow-x-auto p-[24px]">
      ...
      <button className="px-[24px] flex items-center justify-center gap-2 py-[4px] bg-blue-200 text-blue-700 rounded-md">
        <svg
      ...
      <button className="px-[24px] flex items-center justify-center gap-2 py-[4px] bg-blue-200 text-blue-700 rounded-md whitespace-nowrap">
